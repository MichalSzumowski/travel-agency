...
const Trip = ({error, name, image, cost, days, description, country, intro, tripId}) => {
      ...
      <Grid>
        <Row>
          <Col xs={12}>
            ...
            <OrderForm tripCost={cost} tripCountry={country.name} tripName={name} tripId={tripId} countryCode={country.alpha3Code} />
          </Col>
        </Row>
      </Grid>
